...
const ZONES = [
  ...
  },
  {
    ...
    hint:
      ...
      'farmers-market stalls. The cache clings to metal, so a magnet is your friend. Do it before the ' +
  ...
  },
  {
    ...
    hint:
      ...
      'area. The object is wedged among the rocks just below the rail, so mind the wind, it will try to ' +
  ...
  },
  {
    ...
    hint:
      ...
      'tide first, since this one is only reachable at low water). Near the cave entrance, above the reach ' +
